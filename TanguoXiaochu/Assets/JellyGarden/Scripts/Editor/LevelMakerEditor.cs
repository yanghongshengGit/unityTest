...
public class LevelMakerEditor : EditorWindow
{
	...
	string[] toolbarStrings = new string[] { "Editor", "Settings", "Shop", "In-apps", "Ads", "GUI", "Rate" };
	...
	void GUIAds ()
	{
		...
		initscript.enableAds = EditorGUILayout.Toggle ("Enable ads", initscript.enableAds, new GUILayoutOption[] {
			GUILayout.Width (50),
			GUILayout.MaxWidth (200)
		});
		GUILayout.Space (10);
       
		initscript.unityAdsIDAndroid = EditorGUILayout.TextField ("Unity Ads id Android", initscript.unityAdsIDAndroid, new GUILayoutOption[] {
			GUILayout.Width (100),
			GUILayout.MaxWidth (200)
		});

		initscript.unityAdsIDIOS = EditorGUILayout.TextField ("Unity Ads id iOS", initscript.unityAdsIDIOS, new GUILayoutOption[] {
			GUILayout.Width (100),
			GUILayout.MaxWidth (200)
		});
		GUILayout.Space (10);
		initscript.rewardedVideoZone = EditorGUILayout.TextField ("Rewarded video zone id", initscript.rewardedVideoZone, new GUILayoutOption[] {
			GUILayout.Width (300),
			GUILayout.MaxWidth (300)
		});
		initscript.nonRewardedVideoZone = EditorGUILayout.TextField ("Non-Rewarded video zone id", initscript.nonRewardedVideoZone, new GUILayoutOption[] {
			GUILayout.Width (300),
			GUILayout.MaxWidth (300)
		});
		GUILayout.Space (10);
		GUILayout.BeginHorizontal ();
		initscript.ShowChartboostAdsEveryLevel = EditorGUILayout.IntField ("Show Chartboost ads every ", initscript.ShowChartboostAdsEveryLevel, new GUILayoutOption[] {
			GUILayout.Width (220),
			GUILayout.MaxWidth (220)
		});
		GUILayout.Label (" level (0 = disable)", EditorStyles.label, new GUILayoutOption[] { GUILayout.Width (150) });
		...
		GUILayout.EndHorizontal ();
		GUILayout.BeginHorizontal ();
		initscript.ShowAdmobAdsEveryLevel = EditorGUILayout.IntField ("Show Admob ads every ", initscript.ShowAdmobAdsEveryLevel, new GUILayoutOption[] {
			GUILayout.Width (220),
			GUILayout.MaxWidth (220)
		});
		GUILayout.Label (" level (0 = disable)", EditorStyles.label, new GUILayoutOption[] { GUILayout.Width (150) });
		...
		if (initscript.ShowChartboostAdsEveryLevel < 0)
			initscript.ShowChartboostAdsEveryLevel = 1;
		if (initscript.ShowAdmobAdsEveryLevel < 0)
			initscript.ShowAdmobAdsEveryLevel = 0;
		GUILayout.Space (10);
	...
	void GUISettings ()
	{
		...
		lm.FacebookDisable = EditorGUILayout.Toggle ("Disable Facebook", lm.FacebookDisable, new GUILayoutOption[] {
			GUILayout.Width (50),
			GUILayout.MaxWidth (200)
		});
		GUILayout.Space (10);
